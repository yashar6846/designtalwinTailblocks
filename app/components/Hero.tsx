...
const Hero = () => {
  ...
  <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
    <img className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="https://t4.ftcdn.net/jpg/04/31/89/39/360_F_431893913_vpGxndMDShXEwC44i7CzM4amNEEWuZmg.jpg" />
